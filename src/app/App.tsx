...
type Page = "home" | "create-profile" | "qr-success" | "login";
    ...
    <nav className="bg-white/95 backdrop-blur border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        ...
        <div className="hidden sm:flex items-center gap-6 text-sm font-medium text-gray-600">
          ...
          <button className="hover:text-gray-900 transition-colors">Acceso médico</button>
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button className="flex items-center gap-2 bg-white/10 border border-white/30 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-xl transition-colors">
      ...
      <section className="bg-white py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-md mx-auto mb-12">
            Configuralo en minutos. Funciona sin que estés consciente, sin que tu celular esté
            desbloqueado.
          </p>
            ...
            {[
              {
                ...
                desc: "Cargá tus datos médicos críticos: alergias, medicación, condiciones y contactos de emergencia.",
              },
              {
                n: "02",
                icon: <QrCode size={20} className="text-red-500" />,
                title: "Generá tu QR",
                desc: "Obtené un código QR seguro y revocable. Imprimilo en una pulsera, tarjeta o llevalo en tu celular.",
              },
              {
                n: "03",
                icon: <Phone size={20} className="text-red-500" />,
                title: "En una emergencia",
                desc: "Cualquier persona que escanee el QR accede en segundos a tu información vital y puede alertar al SAME.",
              },
            ].map(({ n, icon, title, desc }) => (
              <div
                key={n}
                className="border border-gray-100 rounded-2xl p-6 text-left hover:shadow-md transition-shadow"
              >
      ...
      <section className="bg-gray-50 py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-md mx-auto mb-12">
            Desde el paciente hasta la obra social, cada rol tiene su interfaz optimizada para el
            momento crítico.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={role}
                className="bg-white border border-gray-100 rounded-2xl p-5 text-left flex flex-col"
              >
          ...
          {[
            {
              ...
              desc: "Cumplimiento estricto con la Ley 25.326 de protección de datos personales. Sin rastreo permanente, sin venta de datos.",
            },
            {
              icon: <Star size={16} className="text-emerald-600" />,
              title: "Respaldo legal para el interviniente",
              desc: "Encuadrado en el Estado de Necesidad (Art. 34 CP) y la Obligación de Socorro (Art. 108 CP). Ayudá con tranquilidad.",
            },
            {
              icon: <Zap size={16} className="text-amber-500" />,
              title: "Tokens revocables",
              desc: "Si perdés tu pulsera o tarjeta QR, invalidala al instante desde tu perfil. El QR viejo queda inutilizable de forma inmediata.",
            },
          ].map(({ icon, title, desc }) => (
      ...
      <section className="bg-red-600 py-16 px-4 sm:px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-3">
          Tu QR puede salvar tu vida.
        </h2>
        <p className="text-white/80 max-w-xl mx-auto mb-8">
          En un accidente de tránsito, una crisis diabética o una reacción alérgica, cada segundo
          cuenta. Registrarte es gratis y toma menos de 5 minutos.
        </p>
        <button
          onClick={() => onNavigate("create-profile")}
...
function CreateProfilePage({ onNavigate }: { onNavigate: (p: Page) => void }) {
  ...
  function addCondition() {
    ...
    setData((d) => ({
      ...
      conditions: [
        ...d.conditions,
        { id: Date.now(), type: condType, severity: condSev, description: condDesc },
      ],
    }));
    setCondDesc("");
  }
  ...
  function addMedication() {
    ...
    setData((d) => ({
      ...
      medications: [
        ...d.medications,
        { id: Date.now(), name: medName, dose: medDose, frequency: medFreq },
      ],
    }));
    setMedName("");
    setMedDose("");
  ...
  function addContact() {
    setData((d) => ({
      ...d,
      contacts: [...d.contacts, { id: Date.now(), name: "", relation: "", phone: "" }],
    }));
  }
            ...
            <div className="space-y-5">
              <div>
                <label className="text-sm font-semibold text-gray-700 block mb-1">
                  Alias público <span className="text-red-500">*</span>
                </label>
                <p className="text-xs text-gray-400 mb-1.5">
                  Nombre que verá quien te asista. Puede ser solo tu nombre de pila por privacidad.
                </p>
                <input
                  type="text"
                  value={data.alias}
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-600 font-medium">
                    Aparecerán destacadas en amarillo en tu perfil de emergencia
                  </p>
                </div>
              </div>
              ...
              <div className="border border-gray-100 rounded-xl p-4 mb-3">
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <select
                    value={condSev}
                    onChange={(e) => setCondSev(e.target.value)}
                    className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="w-9 h-9 bg-amber-500 hover:bg-amber-600 text-white rounded-lg flex items-center justify-center transition-colors"
                  >
                    <Plus size={16} />
                  </button>
                </div>
              ...
              {data.conditions.map((c) => (
                <div
                  key={c.id}
                  className={cn(
                    "flex items-center justify-between border rounded-lg px-3 py-2 mb-2 text-sm",
                    sevColor[c.severity] || "bg-gray-50 border-gray-200"
                  )}
                >
                  <div>
                  ...
                  <button onClick={() => removeCondition(c.id)} className="opacity-40 hover:opacity-70">
                    <X size={14} />
                  </button>
                </div>
              ))}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              {data.medications.map((m) => (
                <div
                  key={m.id}
                  className="flex items-center justify-between border border-gray-100 rounded-lg px-3 py-2 mb-2 text-sm"
                >
                  <div>
                  ...
                  <button onClick={() => removeMedication(m.id)} className="text-gray-300 hover:text-gray-500">
                    <X size={14} />
                  </button>
                </div>
              ))}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-400 mb-3">
                Solo visible para médicos y paramédicos certificados (Nivel 3 de acceso).
              </p>
              <textarea
                rows={4}
                value={data.medNotes}
                onChange={(e) => setData({ ...data, medNotes: e.target.value })}
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              {data.contacts.map((contact, idx) => (
                <div
                  ...
                  className={cn(
                    "rounded-xl p-4 mb-3",
                    idx === 0 ? "bg-blue-50 border border-blue-100" : "bg-gray-50 border border-gray-100"
                  )}
                >
                  <p className="text-xs font-bold text-blue-600 mb-3">
                    {idx === 0 ? "Contacto principal (ICE)" : `Contacto adicional ${idx + 1}`}
                  </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Subí estudios relevantes como ECG,{" "}
                <span className="text-blue-500">análisis de sangre</span>, etc. Solo los médicos
                autorizados podrán verlos.
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                {["Electrocardiograma", "Análisis de sangre", "Ecocardiograma", "Otro"].map((t) => (
                  <button
                    key={t}
                    className="flex items-center gap-1.5 border border-gray-200 rounded-lg px-3 py-1 text-xs text-gray-600 hover:bg-gray-50 transition-colors"
                  >
                    <FileText size={11} /> {t}
                  </button>
                ))}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                {[
                  {
                    ...
                    desc: "Al presionar el botón de alerta, se enviará tu ubicación GPS al SAME y tus contactos ICE. La captura es reactiva: solo ocurre cuando alguien active una alerta.",
                    locked: true,
                  },
                  {
                    key: "publicProfile" as const,
                    title: "Perfil público de emergencia",
                    badge: "Requerido",
                    badgeColor: "bg-red-100 text-red-700",
                    desc: "Cualquier persona con tu QR puede ver tu alias, condiciones críticas y contactos ICE. Es necesario para que el sistema funcione.",
                    locked: true,
                  },
                  {
                    key: "medAccess" as const,
                    title: "Acceso ampliado para médicos certificados",
                    badge: null,
                    desc: "Los médicos y paramédicos con matrícula verificada pueden acceder a tu historial completo, medicación y estudios.",
                    locked: false,
                  },
                  {
                    key: "obraReports" as const,
                    title: "Reportes a obra social (anonimizado)",
                    badge: null,
                    desc: "Permite que tu obra social reciba datos de siniestralidad anónimos para mejorar la cobertura. Sin información identificatoria.",
                    locked: false,
                  },
                  ...
                  <div key={key} className="flex items-start justify-between gap-4 py-3 border-b border-gray-50 last:border-0">
                    ...
                    <Toggle
                      checked={data[key]}
                      onChange={(v) => !locked && setData({ ...data, [key]: v })}
                    />
                  </div>
                ))}
              </div>
              ...
              <div className="mt-4 bg-amber-50 border border-amber-200 rounded-xl p-4">
                <p className="text-xs text-amber-800 leading-relaxed">
                  <strong>Autorización legal:</strong> Al registrarte en AyudAPI autorizás expresamente
                  a que cualquier persona que encuentre tu código QR en tu persona revise tus pertenencias
                  en caso de emergencia, conforme el Art. 34 del Código Penal (Estado de Necesidad) y el
                  Art. 108 (Obligación de Socorro). Los datos son de tu exclusiva responsabilidad. AyudAPI
                  actúa únicamente como canal de transmisión sin emitir diagnósticos. Ley 25.326.
                </p>
              </div>
            </div>
    ...
    >
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-sm p-8">
        ...
        <p className="text-sm text-gray-500 text-center mb-6">
          ...
          <span className="text-blue-500">tarjeta</span> o{" "}
          <span className="text-blue-500">pulsera</span> para tener siempre a mano.
        </p>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-5">
          ...
          <p className="text-xs text-blue-500 mt-1">
            Podés revocar este QR en cualquier momento desde tu perfil.
          </p>
        </div>
        ...
        <div className="space-y-2.5">
          ...
          <button className="w-full flex items-center justify-center gap-2 border border-gray-200 hover:bg-red-50 text-red-600 font-semibold py-3 rounded-xl transition-colors text-sm">
